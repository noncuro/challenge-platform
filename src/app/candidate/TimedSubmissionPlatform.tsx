...
}> = ({timeLeft, isOvertime, challengeStatus, startChallengeMutation}) => {
    return (
                    ...
                    {!challengeStatus?.isStarted ? (
                        ...
                        <div className="flex items-center space-x-6">
                            <div className="flex items-center space-x-2">
                                ...
                                <span
                                    className={`text-2xl font-bold ${isOvertime ? 'text-red-400' : 'text-green-400'}`}>
        ...
        <div className="mt-8 bg-gray-800 rounded-lg p-6 shadow-lg border border-gray-700">
            ...
            <div className="mt-4 flex flex-col md:flex-row justify-between items-stretch gap-4">
                ...
                >
                    ...
                    {isSubmitting ? 'Submitting...' : canSubmitOvertime ? 'Submit Late' : 'Submit'}
                </Button>
            </div>
            {canSubmitOvertime && (
            ...
            <div className="min-h-screen bg-gray-900 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <Button
                        ...
                        disabled={startChallengeMutation.isPending}
                    >
                        {startChallengeMutation.isPending ? 'Initializing...' : "Let's do this thing!"}
                    </Button>
                </div>
            </div>
        );
    ...
    return (
        <div className="min-h-screen bg-gray-900">
            ...
            <div className="container mx-auto px-6 py-8">
                <Card
                    className="w-full max-w-4xl mx-auto bg-gray-800 text-white shadow-xl border border-gray-700 rounded-lg overflow-hidden">
